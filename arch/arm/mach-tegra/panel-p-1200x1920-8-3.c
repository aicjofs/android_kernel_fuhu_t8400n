...
static struct tegra_dsi_cmd dsi_p_1200x1920_8_3_init_cmd[] = {
...
static struct tegra_dsi_cmd dsi_p_1200x1920_8_3_suspend_cmd[] = {
	/* no init command required */
...
struct tegra_dsi_out dsi_p_1200x1920_8_3_pdata = {
	...
	.dsi_init_cmd = dsi_p_1200x1920_8_3_init_cmd,
	.n_init_cmd = ARRAY_SIZE(dsi_p_1200x1920_8_3_init_cmd),
	.dsi_suspend_cmd = dsi_p_1200x1920_8_3_suspend_cmd,
	.n_suspend_cmd = ARRAY_SIZE(dsi_p_1200x1920_8_3_suspend_cmd),
...
static int dsi_p_1200x1920_8_3_enable(struct device *dev)
{
	int err = 0;
...
static int dsi_p_1200x1920_8_3_disable(void)
{
...
static int dsi_p_1200x1920_8_3_postsuspend(void)
{
	return 0;
}
static struct tegra_dc_mode dsi_p_1200x1920_8_3_modes[] = {
	{
		.pclk = 155500000,
		.h_ref_to_sync = 4, 
		.v_ref_to_sync = 1,
...
static struct tegra_dc_cmu dsi_p_1200x1920_8_3_cmu = {
...
static int dsi_p_1200x1920_8_3_bl_notify(struct device *unused, int brightness)
{
#if 0	
	...
	if (brightness > 255)
		...
		brightness = dsi_p_1200x1920_8_3_bl_output_measured[brightness];
...
static int dsi_p_1200x1920_8_3_check_fb(struct device *dev, struct fb_info *info)
{
	return info->device == &disp_device->dev;
}

static int dsi_p_1200x1920_8_3_display_init(struct device *dev)
{
	return atomic_read(&display_ready);
}

static struct platform_pwm_backlight_data dsi_p_1200x1920_8_3_bl_data = {
	.pwm_id		= 1,
	.max_brightness	= 255,
	.dft_brightness	= 224,
	.pwm_period_ns	= 1000000,
	.notify		= dsi_p_1200x1920_8_3_bl_notify,
	.edp_states = { 3950, 2950, 1850, 940, 750, 0},
	.edp_brightness = {255, 213, 136, 73, 60, 0},
	/* Only toggle backlight on fb blank notifications for disp1 */
	.check_fb	= dsi_p_1200x1920_8_3_check_fb,
	.init = dsi_p_1200x1920_8_3_display_init,
};

static struct platform_device __maybe_unused
		dsi_p_1200x1920_8_3_bl_device = {
	.name	= "pwm-backlight",
	.id	= -1,
	.dev	= {
		.platform_data = &dsi_p_1200x1920_8_3_bl_data,
	},
};

static struct platform_device __maybe_unused
			*dsi_p_1200x1920_8_3_bl_devices[] __initdata = {
	&tegra_pwfm1_device,
	&dsi_p_1200x1920_8_3_bl_device,
};

static int  __init dsi_p_1200x1920_8_3_register_bl_dev(void)
{
	int err = 0;
	err = platform_add_devices(dsi_p_1200x1920_8_3_bl_devices,
				ARRAY_SIZE(dsi_p_1200x1920_8_3_bl_devices));
	if (err) {
...
static void dsi_p_1200x1920_8_3_set_disp_device(
	struct platform_device *display_device)
{
	disp_device = display_device;
}

static void dsi_p_1200x1920_8_3_resources_init(struct resource *
...
static void dsi_p_1200x1920_8_3_dc_out_init(struct tegra_dc_out *dc)
{

	dc->dsi = &dsi_p_1200x1920_8_3_pdata;
	dc->parent_clk = "pll_d_out0";
	dc->modes = dsi_p_1200x1920_8_3_modes;
	dc->n_modes = ARRAY_SIZE(dsi_p_1200x1920_8_3_modes);
	dc->enable = dsi_p_1200x1920_8_3_enable;
	dc->disable = dsi_p_1200x1920_8_3_disable;
	dc->postsuspend	= dsi_p_1200x1920_8_3_postsuspend,
	dc->width = 111;
	dc->height = 178;
	dc->flags = DC_CTRL_MODE;
}

static void dsi_p_1200x1920_8_3_fb_data_init(struct tegra_fb_data *fb)
{
	fb->xres = dsi_p_1200x1920_8_3_modes[0].h_active;
	fb->yres = dsi_p_1200x1920_8_3_modes[0].v_active;
}

static void
dsi_p_1200x1920_8_3_sd_settings_init(struct tegra_dc_sd_settings *settings)
{
	settings->bl_device_name = "pwm-backlight";
}

static void dsi_p_1200x1920_8_3_cmu_init(struct tegra_dc_platform_data *pdata)
{
#ifdef CONFIG_TEGRA_DC_CMU
	pdata->cmu = &dsi_p_1200x1920_8_3_cmu;
#endif
}

struct tegra_panel __initdata dsi_p_1200x1920_8_3 = {
	.init_sd_settings = dsi_p_1200x1920_8_3_sd_settings_init,
	.init_dc_out = dsi_p_1200x1920_8_3_dc_out_init,
	.init_fb_data = dsi_p_1200x1920_8_3_fb_data_init,
	.init_resources = dsi_p_1200x1920_8_3_resources_init,
	.register_bl_dev = dsi_p_1200x1920_8_3_register_bl_dev,
	.init_cmu_data = dsi_p_1200x1920_8_3_cmu_init,
	.set_disp_device = dsi_p_1200x1920_8_3_set_disp_device,
};
EXPORT_SYMBOL(dsi_p_1200x1920_8_3);
