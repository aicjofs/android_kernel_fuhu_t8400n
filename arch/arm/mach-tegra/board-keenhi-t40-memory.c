...
struct tegra11_emc_table e1545_h5tc4g63mfr_samsung_T40S_table[] =
{
	{
		0x42,       /* Rev 4.0.3 */
...
static struct tegra11_emc_table e1545_h5tc4g63mfr_pba_elpida_T40S_table[] =
{
	{
		0x42,       /* Rev 4.0.3 */
		12750,      /* SDRAM frequency */
...
static struct tegra11_emc_table e1545_h5tc4g63mfr_singlesided_elpida_T40S_table[] =
{
	{
		0x42,       /* Rev 4.0.3 */
		12750,      /* SDRAM frequency */
		...
		},
		{
			...
			0x00064000, /* EMC_DLL_XFORM_DQ1 */
			0x00064000, /* EMC_DLL_XFORM_DQ2 */
			0x00064000, /* EMC_DLL_XFORM_DQ3 */
			0x00000000, /* EMC_DLI_TRIM_TXDQS1 */
			0x00000000, /* EMC_DLI_TRIM_TXDQS2 */
			0x00000000, /* EMC_DLI_TRIM_TXDQS3 */
			0x00000000, /* EMC_DLL_XFORM_QUSE1 */
	...
	},
	{
		...
		},
		{
			...
			0x00000000, /* EMC_DLI_TRIM_TXDQS0 */
			0x00000000, /* EMC_DLL_XFORM_ADDR1 */
			0x00050000, /* EMC_DLL_XFORM_ADDR2 */
...
struct tegra11_emc_table e1545_h5tc4g63mfr_hynix_T40S_table[] =
{
	{
		0x42,       /* Rev 4.0.3 */
		12750,      /* SDRAM frequency */
...
struct tegra11_emc_table e1545_h5tc4g63mfr_nanya_T40S_table[] =
{
	{
		0x42,       /* Rev 4.0.3 */
		12750,      /* SDRAM frequency */
	...
	},
	{
		...
		11,         /* number of up_down_regs */
		{
			...
			0x00000001, /* EMC_PCHG2PDEN */
			0x00000000, /* EMC_ACT2PDEN */
			0x00000012, /* EMC_AR2PDEN */
			0x0000000f, /* EMC_RW2PDEN */
			0x00000016, /* EMC_TXSR */
			0x00000016, /* EMC_TXSRDLL */
			0x00000004, /* EMC_TCKE */
			0x00000004, /* EMC_TCKESR */
			0x00000004, /* EMC_TPD */
			0x00000004, /* EMC_TFAW */
	...
	},
	{
		...
		11,         /* number of up_down_regs */
		{
			...
			0x00020000, /* EMC_ZCAL_INTERVAL */
			0x00000100, /* EMC_ZCAL_WAIT_CNT */
			0x0164000c, /* EMC_MRS_WAIT_CNT */
			0x0164000c, /* EMC_MRS_WAIT_CNT2 */
			0x00000000, /* EMC_AUTO_CAL_CONFIG2 */
			0x00000000, /* EMC_AUTO_CAL_CONFIG3 */
			0x00000000, /* EMC_CTT */
			0x00000000, /* EMC_CTT_DURATION */
	...
	},
	{
		...
		11,         /* number of up_down_regs */
		{
			...
			0x00020000, /* EMC_ZCAL_INTERVAL */
			0x00000100, /* EMC_ZCAL_WAIT_CNT */
			0x0124000c, /* EMC_MRS_WAIT_CNT */
			0x0124000c, /* EMC_MRS_WAIT_CNT2 */
			0x00000000, /* EMC_AUTO_CAL_CONFIG2 */
			0x00000000, /* EMC_AUTO_CAL_CONFIG3 */
			0x00000000, /* EMC_CTT */
			0x00000000, /* EMC_CTT_DURATION */
	...
	},
	{
		...
		11,         /* number of up_down_regs */
		{
			...
			0x00020000, /* EMC_ZCAL_INTERVAL */
			0x00000100, /* EMC_ZCAL_WAIT_CNT */
			0x0109000c, /* EMC_MRS_WAIT_CNT */
			0x0109000c, /* EMC_MRS_WAIT_CNT2 */
			0x00000000, /* EMC_AUTO_CAL_CONFIG2 */
			0x00000000, /* EMC_AUTO_CAL_CONFIG3 */
			0x00000000, /* EMC_CTT */
			0x00000000, /* EMC_CTT_DURATION */
	...
	},
	{
		...
		11,         /* number of up_down_regs */
		{
			...
			0x00020000, /* EMC_ZCAL_INTERVAL */
			0x00000100, /* EMC_ZCAL_WAIT_CNT */
			0x00d9000c, /* EMC_MRS_WAIT_CNT */
			0x00d9000c, /* EMC_MRS_WAIT_CNT2 */
			0x00000000, /* EMC_AUTO_CAL_CONFIG2 */
			0x00000000, /* EMC_AUTO_CAL_CONFIG3 */
			0x00000000, /* EMC_CTT */
			0x00000000, /* EMC_CTT_DURATION */
...
#define EMC_DESCR(_name) "e1545_h5tc4g63mfr_T40S_"#_name
#define GET_EMC_PDATA(_name)  &e1545_h5tc4g63mfr_##_name##_T40S_pdata
#define TEGRA11_EMC_PDATA(_var)	\
	static struct tegra11_emc_pdata e1545_h5tc4g63mfr_##_var##_T40S_pdata =		\
	{								\
		.description = EMC_DESCR(_var),		\
		.tables = e1545_h5tc4g63mfr_##_var##_T40S_table,		\
		.num_tables = ARRAY_SIZE(e1545_h5tc4g63mfr_##_var##_T40S_table),		\
	}

TEGRA11_EMC_PDATA(pba_elpida);
TEGRA11_EMC_PDATA(samsung);
TEGRA11_EMC_PDATA(singlesided_elpida);
TEGRA11_EMC_PDATA(hynix);
TEGRA11_EMC_PDATA(nanya);

#define EMC_RAM_CODE0  TEGRA_GPIO_PG4
#define EMC_RAM_CODE1  TEGRA_GPIO_PG5

#define NANYA_INDEX  0
#define HYNIX_INDEX  1
#define SAMSUNG_INDEX  2
#define ELPIDA_INDEX  3

static struct tegra11_emc_pdata *keenhi_t40_get_emc_data(void)
{	
	int ret,emc_index;
	int ram0_val = 0,ram1_val = 0;
	struct tegra11_emc_pdata *emc_padata;
	ret = gpio_request(EMC_RAM_CODE0, "ram_code0");
	if (ret < 0) {
		pr_err("%s: gpio_request failed for gpio %s\n",
			__func__, "EMC_RAM_CODE0");
	}
	gpio_direction_input(EMC_RAM_CODE0);
	ret = gpio_request(EMC_RAM_CODE1, "ram_code1");
	if (ret < 0) {
		pr_err("%s: gpio_request failed for gpio %s\n",
			__func__, "EMC_RAM_CODE1");
	}
	gpio_direction_input(EMC_RAM_CODE1);
	ram0_val = gpio_get_value(EMC_RAM_CODE0);
	ram1_val = gpio_get_value(EMC_RAM_CODE1);

	emc_index = ram0_val*1+ram1_val*2;
	//samsung 10 ->0*1+1*2= 2;
	//elpida 11 ->1*1+1*2 = 3;
	switch(emc_index){
		case NANYA_INDEX:
			{
				emc_padata = GET_EMC_PDATA(nanya);
			}
			break;
		case HYNIX_INDEX:
			{
				emc_padata = GET_EMC_PDATA(hynix);
			}
			break;
		case SAMSUNG_INDEX:
			{
				emc_padata = GET_EMC_PDATA(samsung);
			}
			break;
		case ELPIDA_INDEX:
			if ( machine_is_tb610n())
			{
				emc_padata = GET_EMC_PDATA(singlesided_elpida);
			}
			else
			{
				emc_padata = GET_EMC_PDATA(pba_elpida);
			}
			break;
		default:
			emc_padata = GET_EMC_PDATA(pba_elpida);
	...
	printk("keenhi_t40_get_emc_data: emc_padata desc= %s emc_index=%d\n",emc_padata->description,emc_index);
	return emc_padata;
}
