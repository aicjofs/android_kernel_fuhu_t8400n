#ifndef ___YUV_SENSOR_H__GC2035
#define ___YUV_SENSOR_H__GC2035
...
#define GC2035_IOCTL_SET_MODE		_IOW('o', 1, struct gc2035_mode)
#define GC2035_IOCTL_GET_STATUS		_IOR('o', 2, struct gc2035_status)
#define GC2035_IOCTL_SET_COLOR_EFFECT   _IOW('o', 3, __u8)
#define GC2035_IOCTL_SET_YUV_EXPOSURE   _IOW('o', 4, __u8)//add keenhi for yuv exposure
#define GC2035_IOCTL_SET_WHITE_BALANCE  _IOW('o', 5, __u8)
#define GC2035_IOCTL_SET_SCENE_MODE     _IOW('o', 6, __u8)
#define SENSOR_IOCTL_SET_OP_MODE		_IOW('o', 7, KhOperationalMode)
