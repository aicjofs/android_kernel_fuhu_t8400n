...
#define DEV_TPI "sii8334_PAGE_TPI"
#define DEV_TX_L0 "sii8334_PAGE_TX_L0"
#define DEV_TX_L1 "sii8334_PAGE_TX_L1"
#define DEV_TX_L2 "sii8334_PAGE_TX_L2"
#define DEV_TX_L3 "sii8334_PAGE_TX_L3"
#define DEV_CBUS "sii8334_PAGE_CBUS"


#define TEGRA_MHL_IOCTL_CMDS               _IOWR('i', 1, uint)



struct mhl_sii8334_i2c_map {
	char		page_name[20];
	unsigned short	slave_addr;
};
#define ADD_DEV(_name, _addr) \
	{                                               \
		.page_name ={ _name},   \
		.slave_addr = _addr,                    \
	}
struct mhl_sii8334_platform_data {
	void (*reset) (void);
};
