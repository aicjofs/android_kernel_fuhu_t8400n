...
#define BABBAGE_NOVATEK_TS_RST1  (('k'-'a')*8+4)
#define BABBAGE_NOVATEK_TS_INT1 (('k'-'a')*8+2)
...
#define NOVATEK_MULTI_TOUCH
	...
	#if defined(CONFIG_MACH_TERRA10) || defined CONFIG_MACH_T8400N_8_3CM
	#define MAX_FINGER_NUM	 10	//5
	#else
