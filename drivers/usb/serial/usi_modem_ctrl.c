...
#define USI_MODEM_USBEN     161//TEGRA_GPIO_PU1      /* Customize by different HW layout and GPIO pin mapping */
#define USI_MODEM_UARTEN  	77//TEGRA_GPIO_PJ5      /* Customize by different HW layout and GPIO pin mapping */
#define USI_MODEM_APReady  	78//TEGRA_GPIO_PJ6      /* Customize by different HW layout and GPIO pin mapping */
#define USI_MODEM_APWAKE	168//TEGRA_GPIO_PV0      /* Customize by different HW layout and GPIO pin mapping */
