...
#define GTP_HAVE_TOUCH_KEY    0		// 触摸按键开关，仅带有触摸按键的 TP 需要打开
#define GTP_POWER_CTRL_SLEEP  0
#define GTP_ICS_SLOT_REPORT   0

#define GTP_AUTO_UPDATE       0    // auto update fw by .bin file as default// 开机搜寻 bin 文件进行固件升级
#define GTP_HEADER_FW_UPDATE  0    // auto update fw by gtp_default_FW in gt9xx_firmware.h, function together with GTP_AUTO_UPDATE// 使用 gt9xx_firmware.h 中的固件升级)需开启 GTP_AUTO_UPDATE)
#define GTP_AUTO_UPDATE_CFG   0    // auto update config by .cfg file, function together with GTP_AUTO_UPDATE // 搜寻.cfg 文件升级（需开启 GTP_AUTO_UPDATE)

#define GTP_COMPATIBLE_MODE   0    // compatible with GT9XXF// 兼容 GT9XXF 模式

#define GTP_CREATE_WR_NODE    1
#define GTP_ESD_PROTECT       0    // esd protection  a cycle of 2 seconds// ESD 防护机制开关

#define GTP_WITH_PEN          0		// 笔事件支持
#define GTP_PEN_HAVE_BUTTON   0    // active pen has bwithuttons, function together with GTP_WITH_PEN// 主动笔带有按键

#define GTP_GESTURE_WAKEUP    0    // gesture wakeup// 手势唤醒
...
#define CTP_CFG_GROUP3 {\
	0x45,0x80,0x07,0x38,0x04,0x0A,0x0C,0x00,0x01,0x08,\
	0x28,0x09,0x5A,0x3C,0x03,0x05,0x00,0x00,0x00,0x00,\
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x95,0x35,0xDD,\
	0x34,0x32,0x6A,0x0D,0x00,0x00,0x00,0x9B,0x03,0x1D,\
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
	0x00,0x50,0x96,0x94,0x95,0x02,0x07,0x00,0x00,0x05,\
	0x0D,0x33,0xCD,0x0D,0x36,0x95,0x0E,0x3A,0x7D,0x12,\
	0x34,0x45,0x13,0x39,0x00,0x00,0x00,0x00,0x00,0x00,\
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
...
#define GTP_RST_PORT    (('k'-'a')*8+4)//S5PV210_GPJ3(6)
#define GTP_INT_PORT    (('k'-'a')*8+2)//S5PV210_GPH1(3)
