...
#define GPIO_IRQ 						82//TEGRA_GPIO_PK2
...
/* Resolution mode */
// Constant value 
#define SIS_MAX_X						1920//4095
#define SIS_MAX_Y						1600//4095
...
#ifdef _ANDROID_4
#define AREA_LENGTH_LONGER				2500//5792 //Resolution diagonal 
#define AREA_LENGTH_SHORT				2500//5792 // ((SIS_MAX_X^2) + (SIS_MAX_Y^2))^0.5
#define AREA_UNIT						1//(2500/32)//(5792/32)
#else
