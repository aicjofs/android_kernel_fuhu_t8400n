...
struct it6681_dev_data {
	...
	wait_queue_head_t otg_mhl_switcher;
	atomic_t mhl_switcher;
    // 3D Option
    //unsigned char En3D;
...
typedef struct
{
    ...
    unsigned char owafe;
    unsigned char afes[16];
    unsigned char afem[16];
    
    unsigned char pd_rx0x0e;
    unsigned char pd_rx0x13;
    unsigned char pd_rx0x14;
    unsigned char pd_rx0x2b;
    unsigned char pd_rx0x09;
    unsigned char pd_rx0x0a;
    unsigned char pd_rx0x0c;
    unsigned char pd_rx0x0d;

    unsigned char pd_tx0x20;
    unsigned char pd_tx0x37;
    unsigned char pd_tx0x62;
    unsigned char pd_tx0x61;
    unsigned char pd_tx0x65;
    unsigned char pd_tx0x67;
    unsigned char pd_tx0xf3;
    
    unsigned char suspend_in_mhl_mode;
